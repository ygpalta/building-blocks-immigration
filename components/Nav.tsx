          ...
          <div className="w-full relative flex justify-between items-center lg:w-auto lg:static lg:block lg:justify-start">
            <Link href='/'>
                ...
                >
                    ...
                    width="90" height="90" 
                    alt="Logo" />
                    <p className='logo text-xl text-white font-bold uppercase tracking-wide'>
              ...
              <li className="flex items-center">
                <a
                  className={
                    ...
                    " px-3 py-4 lg:py-2 flex items-center  uppercase font-bold"
                  }
                  ...
                  <i
                    className={
                      (props.transparent
                        ...
                        : "text-gray-500") +
                      "logo far text-xl text-lg items-center leading-lg mr-2"
                    }
                  />{" "}
                  BUILDING BLOCKS IMMIGRATION
                </a>
